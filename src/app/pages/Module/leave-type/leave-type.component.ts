...
import { CMAdminModuleMasterUser, CMAdminSubModuleMaster, LEmp_Leavemaster } from '@modules/Module/PoModules';
...
ActionStatus:any;
  ...
  LEmp_Leavemaster: List<LEmp_Leavemaster>;
  constructor(
  ...
  async LodeDataTable() {
    ...
    this.LEmp_Leavemaster = Enumerable.from(obj["data"]["pOLempLeavemasters"]).cast<LEmp_Leavemaster>().toList();
 // or List.from(data)
    ...
    // .toList();
     this.persons=this.LEmp_Leavemaster ;
