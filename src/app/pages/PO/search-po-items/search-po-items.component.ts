...
import { CMAdminModuleMasterUser, ExpenseItems, pOTmPurchaseBodies, TM_CountryMaster, TM_PurchaseHead, Tm_supplierMaster } from '@modules/Module/PoModules';
...
@Component({
  selector: 'app-search-po-items',
  templateUrl: './search-po-items.component.html',
  styleUrls: ['./search-po-items.component.scss']
})
export class SearchPoItemsComponent implements OnInit {
...
id: number,
  ...
  async LodeDataTable() {
    ...
    this.pOTmPurchaseBodiess=this.pOTmPurchaseBodiess.orderByDescending(x=>x.poId);
